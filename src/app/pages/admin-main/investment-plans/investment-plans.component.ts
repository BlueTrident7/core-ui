...
import {
  InvestmentPlanGetDTO,
  InvestmentPlanPostDto,
...
export class InvestmentPlansComponent implements OnInit, ApiCallBack<any> {
  investmentPlans: InvestmentPlanGetDTO[] = [];
  ...
  saveInvestmentPlan(): void {
    ...
    const investment = new InvestmentPlanPostDto();
